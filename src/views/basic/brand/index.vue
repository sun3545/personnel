      ...
      <avue-crud ref="crud"
        ...
        <template slot="menuLeft">
          <el-button type="primary"
                     @click="handleAdd"
                     size="small"
                     v-if="permissions.shop_clientbrand_add">新 增</el-button>
          <br /><br />
        </template>
        <template slot-scope="scope"
                  slot="menu">
          <el-button type="primary"
                     v-if="permissions.shop_clientbrand_edit"
                     icon="el-icon-check"
                     size="small"
                     plain
                     @click="handleEdit(scope.row,scope.index)">编辑</el-button>
          <el-button type="danger"
                     v-if="permissions.shop_clientbrand_del"
                     icon="el-icon-delete"
                     size="small"
                     plain
...
<script>
  import { fetchList, getObj, addObj, putObj, delObj } from '@/api/basic/clientbrand'
  import { tableOption } from '@/const/crud/basic/clientbrand'
